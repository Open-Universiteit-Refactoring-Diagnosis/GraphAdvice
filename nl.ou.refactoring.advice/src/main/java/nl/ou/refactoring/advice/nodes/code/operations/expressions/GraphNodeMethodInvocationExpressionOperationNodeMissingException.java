...
/**
 * An exception that is thrown if a {@link GraphNodeMethodInvocationExpression}
 * is missing an Operation node.
 */
public final class GraphNodeMethodInvocationExpressionOperationNodeMissingException extends GraphValidationException {
	...
	/**
	 * The expression that invokes a method.
	 */
	 ...
	 * 
	 * @param expressionNode The Method Invocation Expression node that is missing
	 *                       an Operation node.
	 */
	 ...
	 * 
	 * @return The Method Invocation Expression node that is missing an operation
	 *         node.
	 */
	...
	public String getLocalizedMessage() {
		final var messageTemplate =
				ResourceProvider.ExceptionMessages
						.getMessageTemplate(GraphNodeMethodInvocationExpressionOperationNodeMissingException.class);
