...
/**
 * A validation result that indicates whether a Double Definition risk node is missing when it is expected.
 */
public final class GraphNodeRiskDoubleDefinitionPresentWhenRequiredValidationResult extends GraphValidationFixableResult {
	 ...
	 * @throws ArgumentNullException Thrown if graph, nodesExisting or nodeAdded is null.
	 */
	 ...
	 * @return An unmodifiable set of existing nodes that have an identical signature.
	 */
	public Set<GraphNodeCode> getNodesExisting() {
