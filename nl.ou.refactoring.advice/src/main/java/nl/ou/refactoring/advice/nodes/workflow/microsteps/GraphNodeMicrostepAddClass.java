...
public final class GraphNodeMicrostepAddClass extends GraphNodeMicrostep {
	 ...
	 */
	public GraphNodeMicrostepAddClass(Graph graph) throws ArgumentNullException {
		super(graph);
	}
	 ...
	 * 
	 * @param classNode The node that represents the class that is added to the code
	 *                  context.
	...
	/**
	 * Gets the {@link GraphNodeClass} node that represents the class that is added
	 * by the microstep.
	 * 
	 * @return The {@link GraphNodeClass} node that represents the class that is
	 *         added by the microstep, or null if there is none.
