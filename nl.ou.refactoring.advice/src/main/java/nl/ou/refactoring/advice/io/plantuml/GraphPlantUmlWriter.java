...
public abstract class GraphPlantUmlWriter extends GraphStringWriter {
	...
	/**
	 * Writes a "sprite" directive for a PlantUML diagram, that draws a minus icon.<br />
	 * Generated by <a href="https://chat.mistral.ai/">Le Chat</a> from Mistral.ai
	 * @param name The name of the sprite.
	 */
	protected final void writeSpriteMinus(String name) {
		this.printLine(
			String.format(
				"sprite %s <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" xmlns:v=\"https://vecta.io/nano\">\r\n"
				+ "  <path d=\"M0 7h16v2H0z\" fill=\"#FF0000\"/>\r\n"
				+ "</svg>",
				name
			)
		);
	...
	/**
	 * Writes a "sprite" directive for a PlantUML diagram, that draws a plus icon.<br />
	 * Generated by <a href="https://chat.mistral.ai/">Le Chat</a> from Mistral.ai
	 * @param name The name of the sprite.
	 */
