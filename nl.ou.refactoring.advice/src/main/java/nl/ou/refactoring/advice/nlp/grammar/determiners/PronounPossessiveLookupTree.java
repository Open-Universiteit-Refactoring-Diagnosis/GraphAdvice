...
public final class PronounPossessiveLookupTree
	...
	private static PronounPossessiveLookupTreeNode<Void, GrammaticalPerson> constructTree() {
		final var rootNode = new PronounPossessiveLookupTreeNode<Void, GrammaticalPerson>(null, null);
		
		// First Person
		// First Person Singular
		final var mijnValue =
			new PronounPossessiveLookupTreeNode<String, Void>("mijn", _ -> "mijn");
		final var firstPersonSingular =
			new PronounPossessiveLookupTreeNode<GrammaticalNumber, String>(GrammaticalNumber.SINGULAR, k -> k.number());
		firstPersonSingular.putIfAbsent(mijnValue);
		
		// First Person Plural
		final var onsValue =
			new PronounPossessiveLookupTreeNode<String, Void>("ons", _ -> "ons");
		final var onzeValue =
			new PronounPossessiveLookupTreeNode<String, Void>("onze", _ -> "onze");
		
		final var firstPersonPluralModifierNeuterSingular =
			new PronounPossessiveLookupTreeNode<GrammaticalNumber, String>(GrammaticalNumber.SINGULAR, k -> k.numberModifier());
		firstPersonPluralModifierNeuterSingular.putIfAbsent(onsValue);

		final var firstPersonPluralModifierNeuterPlural =
			new PronounPossessiveLookupTreeNode<GrammaticalNumber, String>(GrammaticalNumber.PLURAL, k -> k.numberModifier());
		firstPersonPluralModifierNeuterPlural.putIfAbsent(onzeValue);
		final var firstPersonPluralModifierNeuter =
			new PronounPossessiveLookupTreeNode<GrammaticalGender, GrammaticalNumber>(GrammaticalGender.NEUTER, k -> k.genderModifier());
		...
		final var firstPersonPluralModifierFeminine =
			new PronounPossessiveLookupTreeNode<GrammaticalGender, String>(GrammaticalGender.FEMININE, k -> k.genderModifier());
		firstPersonPluralModifierFeminine.putIfAbsent(onzeValue);
		final var firstPersonPluralModifierMasculine =
			new PronounPossessiveLookupTreeNode<GrammaticalGender, String>(GrammaticalGender.MASCULINE, k -> k.genderModifier());
		firstPersonPluralModifierMasculine.putIfAbsent(onzeValue);
		
		final var firstPersonPlural =
			new PronounPossessiveLookupTreeNode<GrammaticalNumber, GrammaticalGender>(GrammaticalNumber.PLURAL, k -> k.number());
		...
		final var firstPerson =
			new PronounPossessiveLookupTreeNode<GrammaticalPerson, GrammaticalNumber>(GrammaticalPerson.FIRST, k -> k.person());
		...
		final var jouwValue =
			new PronounPossessiveLookupTreeNode<String, Void>("jouw", _ -> "jouw");
		final var secondPersonSingularCasual =
			new PronounPossessiveLookupTreeNode<GrammaticalRegister, String>(GrammaticalRegister.CASUAL, k -> k.register());
		secondPersonSingularCasual.putIfAbsent(jouwValue);
		final var secondPersonSingular =
			new PronounPossessiveLookupTreeNode<GrammaticalNumber, GrammaticalRegister>(GrammaticalNumber.SINGULAR, k -> k.number());
		secondPersonSingular.putIfAbsent(secondPersonSingularCasual);
		
		final var secondPerson =
			new PronounPossessiveLookupTreeNode<GrammaticalPerson, GrammaticalNumber>(GrammaticalPerson.SECOND, k -> k.person());
