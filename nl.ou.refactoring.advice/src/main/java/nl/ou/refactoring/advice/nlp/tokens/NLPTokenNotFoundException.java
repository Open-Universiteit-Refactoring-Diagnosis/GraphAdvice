...
/**
 * An exception that is thrown if a syntax element could not be found by its
 * token.
 */
public final class NLPTokenNotFoundException extends NLPException {
	 ...
	 * @param classType The type of the Class that did not contain the requested
	 *                  syntax element with the specified token.
	 */
	...
	/**
	 * Gets the type of the Class that did not contain the requested syntax element
	 * with the specified token.
	 * 
	 * @return {@link Class} The type of the Class that did not contain the
	 *         requested syntax element with the specified token.
	 */
	...
	public String getLocalizedMessage() {
		final var messageTemplate =
				ResourceProvider.ExceptionMessages.getMessageTemplate(NLPTokenNotFoundException.class);
		return MessageFormat.format(messageTemplate, this.token, this.classType.getName());
	}
}